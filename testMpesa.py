...
api_context.api_key = 'dax2xgy9xo2fsko437zfsrstd4a4za1w'
...
api_context.add_parameter('input_CustomerMSISDN','258847479196')
#api_context.add_parameter('input_CustomerMSISDN',request.data["numeroCelular"])
api_context.add_parameter('input_Amount',30)
